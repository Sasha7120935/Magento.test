...
namespace Fixstacks\Meeting\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(AgendaSetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(AgendaSetup::ENTITY_TYPE_CODE . '_eav_attribute')],
