...
namespace Fixstacks\Meeting\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Fixstacks_Agenda';
     ...
     * @var string
     */
    protected $_eventPrefix = AgendaSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Fixstacks\Meeting\Model\ResourceModel\Attribute');
    }
