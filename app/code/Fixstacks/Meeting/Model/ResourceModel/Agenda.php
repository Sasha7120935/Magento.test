...
namespace Fixstacks\Meeting\Model\ResourceModel;
...
class Agenda extends AbstractEntity
{
    ...
    public function __construct(
        ...
        $this->setType(AgendaSetup::ENTITY_TYPE_CODE);
        $this->setConnection(AgendaSetup::ENTITY_TYPE_CODE . '_read', AgendaSetup::ENTITY_TYPE_CODE . '_write');
        $this->_storeManager = $storeManager;
    }

    /**
     * Retrieve Agenda entity default attributes
     *
     * @return string[]
     */
